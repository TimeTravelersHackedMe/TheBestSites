...
if ( ! function_exists( 'cb_review_boxes' ) ) {
    function cb_review_boxes( $post ){
        ...
        if ( $cb_review_checkbox == 'on' ) {
            ...
            $cb_opener .= '<div class="cb-review-area website-overview"><div class="cb-review-title">Website Name: <span class="gray-text">' . get_post_meta($cb_post_id, 'website_name', true) . '</span></div></div>';
